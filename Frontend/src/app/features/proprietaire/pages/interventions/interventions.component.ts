          ...
          <tbody>
            @for (intervention of filteredInterventions(); track intervention.id) {
              <tr style="border-bottom: 1px solid #e0e0e0;">
                ...
                <td style="padding: 12px 16px; font-size: 13px; color: #333;">{{ intervention.createdAt | dateFr }}</td>
                <td style="padding: 12px 16px; font-size: 14px; font-weight: 600; color: #000;">{{ (intervention.actualCost || intervention.estimatedCost || 0) | montant }} FCFA</td>
                <td style="padding: 12px 16px;">
          ...
          <div style="background: #fff; width: 100%; max-width: 560px; max-height: 85vh; overflow: auto;" (click)="$event.stopPropagation()">
            ...
            <div style="padding: 20px;">
              ...
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 16px;">
                ...
                <div><p style="margin: 0 0 2px; font-size: 11px; color: #999; text-transform: uppercase;">Date</p><p style="margin: 0; font-size: 14px; color: #000; font-weight: 500;">{{ viewTarget().createdAt | dateFr }}</p></div>
                <div><p style="margin: 0 0 2px; font-size: 11px; color: #999; text-transform: uppercase;">Coût estimé</p><p style="margin: 0; font-size: 14px; color: #000; font-weight: 500;">{{ viewTarget().estimatedCost | montant }} FCFA</p></div>
              </div>
