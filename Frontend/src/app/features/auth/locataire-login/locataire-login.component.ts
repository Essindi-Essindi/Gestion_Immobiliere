...
@Component({
  ...
  template: `
    <div class="page">
      ...
      <div class="body">
        <div class="card">
          <h1 class="card-title">Locataire - Connexion</h1>
          <p class="card-subtitle">Accédez à votre espace locataire</p>
          ...
          <div class="links">
            <a routerLink="/auth/locataire/forgot-password" class="link">Mot de passe oublié ?</a>
          </div>
