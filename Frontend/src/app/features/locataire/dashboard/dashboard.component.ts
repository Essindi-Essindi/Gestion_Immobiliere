      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:16px;margin-bottom:24px;">
        ...
        <div style="background:#fff;border:1px solid #e0e0e0;padding:20px;">
          <div style="display:flex;align-items:center;gap:12px;">
            ...
            <div>
              <p style="margin:0;font-size:22px;font-weight:700;color:#000;">{{ formatMontant(stats.monLoyer) }} €</p>
          ...
          <div style="padding:20px;">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
              ...
              <div>
                ...
                <p style="margin:0;font-size:14px;color:#000;font-weight:500;">{{ formatMontant(stats.contrat.rent) }} €</p>
              </div>
              <div>
...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.stats = {
      ...
      dernierPaiement: payes.length ? this.formatDate(payes[0].paidAt) : 'Aucun',
      prochaineEcheance: prochain ? this.months[prochain.month] + ' ' + prochain.year : '-',
      contrat: contrat ? {
        logementAddress: contrat.logementAddress,
        rent: contrat.rent,
        startDate: this.formatDate(contrat.startDate),
        endDate: this.formatDate(contrat.endDate)
