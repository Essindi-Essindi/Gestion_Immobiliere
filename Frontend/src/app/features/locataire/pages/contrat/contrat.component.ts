            ...
            <div style="padding:20px;">
              ...
              <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
                ...
                <div>
                  ...
                  <p style="margin:0;font-size:14px;color:#000;font-weight:500;">{{ contrat.startDate | dateFr }}</p>
                </div>
                <div>
                  <p style="margin:0 0 4px;font-size:12px;color:#757575;text-transform:uppercase;">Date de fin</p>
                  <p style="margin:0;font-size:14px;color:#000;font-weight:500;">{{ contrat.endDate | dateFr }}</p>
                </div>
                <div>
                  <p style="margin:0 0 4px;font-size:12px;color:#757575;text-transform:uppercase;">Loyer mensuel</p>
                  <p style="margin:0;font-size:14px;color:#000;font-weight:500;">{{ contrat.rent | montant }} €</p>
                </div>
                <div>
                  <p style="margin:0 0 4px;font-size:12px;color:#757575;text-transform:uppercase;">Charges</p>
                  <p style="margin:0;font-size:14px;color:#000;font-weight:500;">{{ contrat.charges | montant }} €</p>
                </div>
                <div>
                  <p style="margin:0 0 4px;font-size:12px;color:#757575;text-transform:uppercase;">Dépôt de garantie</p>
                  <p style="margin:0;font-size:14px;color:#000;font-weight:500;">{{ contrat.deposit | montant }} €</p>
                </div>
              </div>
            </div>
          </div>
