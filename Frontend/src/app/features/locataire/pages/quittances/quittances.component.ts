            ...
            <tbody>
              @for (q of filteredQuittances; track q.id) {
                <tr style="border-bottom:1px solid #f0f0f0;">
                  ...
                  <td style="padding:14px 20px;font-size:14px;color:#000;">{{ q.amount | montant }} €</td>
                  <td style="padding:14px 20px;font-size:14px;color:#424242;">{{ q.paidAt ? (q.paidAt | dateFr) : '—' }}</td>
