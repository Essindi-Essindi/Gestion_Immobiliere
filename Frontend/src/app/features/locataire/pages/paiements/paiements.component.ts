    ...
    <div style="padding:24px;background:#f5f5f5;min-height:100vh;">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:24px;">
        <div style="background:#fff;border:1px solid #e0e0e0;padding:20px;text-align:center;">
          ...
          <p style="margin:0;font-size:26px;font-weight:700;color:#000;">{{ totalPaye | montant }} €</p>
        </div>
        <div style="background:#fff;border:1px solid #e0e0e0;padding:20px;text-align:center;">
          <p style="margin:0 0 4px;font-size:12px;color:#757575;text-transform:uppercase;">En attente</p>
          <p style="margin:0;font-size:26px;font-weight:700;color:#616161;">{{ totalEnAttente | montant }} €</p>
        </div>
        <div style="background:#fff;border:1px solid #e0e0e0;padding:20px;text-align:center;">
          <p style="margin:0 0 4px;font-size:12px;color:#757575;text-transform:uppercase;">En retard</p>
          <p style="margin:0;font-size:26px;font-weight:700;color:#424242;">{{ totalEnRetard | montant }} €</p>
        </div>
      </div>
          ...
          <tbody>
            @for (p of filteredPaiements; track p.id) {
              <tr style="border-bottom:1px solid #f0f0f0;">
                ...
                <td style="padding:14px 20px;font-size:14px;color:#000;font-weight:500;">{{ p.amount | montant }} €</td>
                <td style="padding:14px 20px;font-size:14px;color:#424242;">{{ p.paidAt ? (p.paidAt | dateFr) : '—' }}</td>
