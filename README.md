...
**Stack:** Angular 18 (standalone components) frontend in `Frontend/gestion-immobiliere` · Spring Boot API skeleton at the repo root (`pom.xml`) · black / white / grey rectangular UI.
...
├─ pom.xml / src / mvnw*      ← Spring Boot backend (skeleton)
└─ Frontend/gestion-immobiliere/
